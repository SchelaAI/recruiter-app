  ...
  return (
    <div className="workspace-page">
      ...
      <section className="dashboard-metrics">
        <Metric icon={<Icons.user size={18}/>} tone="violet" label="Active Candidates" value={activeCandidatesResult.count ?? 0} foot="currently in coordination" />
        <Metric icon={<Icons.calendar size={18}/>} tone="green" label="Interviews This Week" value={weekInterviewsResult.count ?? 0} foot={`${confirmedWeekResult.count ?? 0} confirmed`} />
        <Metric icon={<Icons.clock size={18}/>} tone="amber" label="Awaiting Reply" value={awaitingResult.count ?? 0} foot={`${overdueResult.count ?? 0} over 24h`} />
        <Metric icon={<Icons.warning size={18}/>} tone="red" label="Escalated" value={escalatedResult.count ?? 0} foot="needs you" />
      </section>
