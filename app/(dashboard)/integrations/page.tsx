        ...
        {connected.map((i) => (
          <div className="card integ-card" key={i.id}>
            ...
            <div className="integ-footer">
              {i.id === "whatsapp" ? (
                <span className="pill-mini slate" title="Set via WHATSAPP_PHONE_NUMBER_ID / WHATSAPP_ACCESS_TOKEN — shared by every org on this deployment.">
                  Managed centrally
                </span>
              ) : (
                <button
          ...
          return (
            <div className="card integ-card" key={i.id}>
              ...
              <div className="integ-synced" style={{ marginBottom: 13 }}>
                {i.id === "whatsapp"
                  ? "This deployment hasn't set up WhatsApp yet — set WHATSAPP_PHONE_NUMBER_ID and WHATSAPP_ACCESS_TOKEN. See SETUP.md."
