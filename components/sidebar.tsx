  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-brand">
        <Image src="/favicon.ico" width={30} height={30} alt="Schela" priority />
      ...
      <div className="sidebar-bottom">
        ...
        <div className="sidebar-user">
          ...
          <form action={signOut}><button type="submit" className="sidebar-signout" aria-label="Sign out"><Icons.logout size={16}/></button></form>
        </div>
      </div>
    </aside>
  );
